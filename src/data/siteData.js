...
const siteData = {
  business: {
    ...
    description: "KeepClean was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
    phone: "+263 77 407 7574",
    phoneRaw: "+263774077574",
    whatsappNumber: "263774077574",
    email: "info@keepclean.co.zw",
    ...
    cookieConsentKey: "keepclean-cookie-consent",
    socialLinks: { facebook: "https://www.facebook.com/allcleanzw/videos/once-off-deep-house-cleaning-services-harare/1327948698795695/", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "KeepClean", logoLine2: "Services" },
  ...
  homeTestimonials: [
    { text: "KeepClean transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "We had a serious cockroach problem. KeepClean came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "Professional, punctual, and incredibly thorough. KeepClean handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "KeepClean was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
  ...
  reviews: {
    ...
    items: [
      { text: "KeepClean transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5 },
      { text: "We had a serious cockroach problem. KeepClean came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5 },
      { text: "Professional, punctual, and incredibly thorough. KeepClean handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. KeepClean exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend KeepClean to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at KeepClean is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. KeepClean has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi KeepClean! I would like to request a quote.",
